...
- **The ball is heavy.** Gravity ~5.5–6.5 m/s² table-relative (steeper than most mobile pinball — we want danger), high ball mass, low bounciness on steel, controlled bounce on rubbers.
